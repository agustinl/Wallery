	...
	Croppic.prototype = {
		...
		bindImgUploadControl: function(){
			...
			if( !$.isEmptyObject(that.croppedImg)){
				...
				$('button#deleteMissingForm').click( function(e) {
				...
				$('button#deleteBloodForm').click( function(e) {
				...
				$('button#cleanMissingForm').click( function(e) {
				...
				$('button#cleanBloodForm').click( function(e) {
